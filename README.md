<p align="center">
  ...
  <br><br>
    ...
    <p align="center">
      SuikaPlayer is a minimalist and elegant music player for Android, designed with a focus on aesthetics and a premium user experience. 
...
SuikaPlayer is built with privacy as a core principle:
...
- **No Data Collection**: SuikaPlayer does not collect, store, or transmit any personal data. Everything stays on your device.
...
SuikaPlayer is designed to be fully open-source and compatible with F-Droid's build standards:
...
height="40">](https://f-droid.org/es/packages/com.demonlab.suikaplayer/)
...
To build SuikaPlayer from source, ensure your environment meets the following requirements:
...
3. **Build via Command Line**:
   ...
   ```
   The output APK will be available at: `app/build/outputs/apk/release/SuikaPlayer-release.apk`
...
<p align=center>
  <b><i></b>💫SuikaPlayer - Listen with style💫</i></b>
</p>
