...
import com.demonlab.suikaplayer.tools.PlaylistBackupManager
...
import com.demonlab.suikaplayer.BuildConfig
    ...
    Surface(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = stringResource(com.demonlab.suikaplayer.R.string.backup_warning_title),
                    fontWeight = FontWeight.Bold,
                ...
                Text(
                    text = stringResource(com.demonlab.suikaplayer.R.string.backup_warning_desc),
